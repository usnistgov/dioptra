...
_arg_backend="dioptra"
_arg_conda_env="base"
_arg_experiment_id=
_arg_entry_point="main"
_arg_mlflow_run_module="dioptra.rq.cli.mlflow"
_arg_s3_workflow=
...
"
  ...
  printf '\t%s\n' "--backend: [dioptra|local] Execution backend for MLFlow (default: 'dioptra')"
  ...
  printf '\t%s\n' "--mlflow-run-module: Python module used to invoke 'mlflow run' (default: 'dioptra.rq.cli.mlflow')"
  ...
  printf '\t%s\n' "DIOPTRA_PLUGIN_DIR: Directory in worker container for syncing the builtin plugins."
  printf '\t%s\n' "DIOPTRA_PLUGINS_S3_URI: S3 URI to the directory containing the builtin plugins."
  printf '\t%s\n' "DIOPTRA_CUSTOM_PLUGINS_S3_URI: S3 URI to the directory containing the custom plugins."
