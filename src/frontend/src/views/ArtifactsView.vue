...
import ParameterList from '@/components/table/cells/ParameterList.vue' // Import the new component
...
const computedColumns = computed(() => [
  ...
  { 
    name: 'taskName', 
    label: 'Task Name', 
    field: row => row.task?.name, // Access nested property
    align: 'left', 
    styleType: 'icon-badge', // "badge icon" per request
    conceptType: 'task',
    uppercase: false,
    chipType: 'outline'
  },
  { 
    ...
    align: 'left',
    style: 'min-width: 200px; width: 300px; white-space: normal;' // Ensure space for the list
  },
  { 
    name: 'download', 
    label: 'Download', 
