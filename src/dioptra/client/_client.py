...
class ExperimentsClient(
    ...
    def delete_jobs_by_experiment_id_job_id(self, experiment_id, job_id):
        d = None
        return self.session.delete(self.url, d, str(experiment_id), "jobs", str(job_id))
...
class PluginsClient(
    ...
    def get_snapshot_by_plugin_id_snapshot_id(self, plugin_id, snapshot_id):
        return self.session.get(self.url, str(plugin_id), "snapshots", str(snapshot_id))
...
class ModelsClient(
    ...
    def modify_version_by_model_id_version_id(self, model_id, version_id, description):
        d = {"description": description}
        return self.session.put(self.url, d, str(model_id), "versions", str(version_id))
