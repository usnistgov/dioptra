...
def assert_resource_type(
    ...
    if isinstance(resource, int):
        ...
        if not resource_obj:
            raise e.EntityDoesNotExistError(EntityType.RESOURCE, resource_id=resource)
...
def _assert_exists_multi(
    ...
    if expected_number is not None and len(existence_result) < expected_number:
        ...
        raise e.EntityDoesNotExistError(EntityType.RESOURCE, resource_id=None)
        ...
        raise e.EntityDoesNotExistError(EntityType.RESOURCE, resource_ids=dne_ids)
        ...
        raise e.EntityDeletedError(
            EntityType.RESOURCE, first_deleted_id, resource_id=first_deleted_id
        )
        ...
        raise e.EntityExistsError(
            EntityType.RESOURCE, first_existing_id, id=first_existing_id
        )
