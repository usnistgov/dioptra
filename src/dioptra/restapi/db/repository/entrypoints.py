...
class EntrypointRepository:
    ...
    def get_exact(  # get_all? get_strict? get_multiple?
        self,
        resource_ids: Sequence[int],
        deletion_policy: utils.DeletionPolicy = utils.DeletionPolicy.NOT_DELETED,
    ) -> Sequence[EntryPoint]:
        """
        Get the latest snapshots of the given entrypoint resource IDs.
    ...
    def create_queues(
        ...
        """
        Add the given queues as children of the given entry point.
