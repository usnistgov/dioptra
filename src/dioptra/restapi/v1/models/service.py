...
class ModelService(object):
    ...
    def create(
        ...
        **kwargs,
        ...
        return utils.ModelWithVersionDict(model=ml_model, version=None, has_draft=False)
        ...
        **kwargs,
        ...
        models_dict: dict[int, utils.ModelWithVersionDict] = {
            model.resource_id: utils.ModelWithVersionDict(
                model=model, version=None, has_draft=False
            )
        ...
        drafts_stmt = select(
            ...
            .as_string()
            .cast(Integer)
            .in_(tuple(model["model"].resource_id for model in models_dict.values())),
    ...
    def get(
        ...
        **kwargs,
        ...
        return utils.ModelWithVersionDict(
            model=ml_model, version=latest_version, has_draft=has_draft
        )
...
class ModelIdVersionsService(object):
    ...
    def get(
        ...
        **kwargs,
        ...
        return [
            utils.ModelWithVersionDict(
                model=ml_model, version=version, has_draft=has_draft
            )
...
class ModelIdVersionsNumberService(object):
    ...
    def get(
        ...
        **kwargs,
        ...
        return utils.ModelWithVersionDict(
            model=ml_model, version=latest_version, has_draft=False
        )
