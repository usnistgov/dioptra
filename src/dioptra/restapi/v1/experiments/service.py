        ...
        **kwargs,
        ...
        experiments_dict: dict[int, utils.ExperimentDict] = {
            experiment.resource_id: utils.ExperimentDict(
                ...
                entrypoints=list(
                    self._uow.experiment_repo.get_children(
                        experiment,
                        DeletionPolicy.NOT_DELETED,
                    )
                ),
...
class ExperimentIdService(object):
    ...
    def get(
        ...
        **kwargs,
        ...
        entrypoints = self._uow.experiment_repo.get_children(
            experiment,
            DeletionPolicy.NOT_DELETED,
        )
...
class ExperimentIdEntrypointsService(object):
    ...
    def append(
        ...
        **kwargs,
        ...
        try:
            all_children = self._uow.experiment_repo.add_children(
                experiment_id,
                entrypoint_ids,
            )
        except Exception:
    ...
    def modify(
        ...
        **kwargs,
        ...
        try:
            entrypoints = self._uow.experiment_repo.set_children(
                experiment_id,
                entrypoint_ids,
            )
        except Exception:
...
class ExperimentIdEntrypointsIdService(object):
    ...
    def delete(self, experiment_id: int, entrypoint_id, **kwargs) -> dict[str, Any]:
        ...
        with self._uow:
            self._uow.experiment_repo.unlink_child(experiment_id, entrypoint_id)
