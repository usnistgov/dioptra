...
from mitre.securingai.sdk.object_detection.augmentations import (
    ImgAugObjectDetectionAugmentations,
    ObjectDetectionAugmentations,
    PassthroughObjectDetectionAugmentations,
)
from mitre.securingai.sdk.object_detection.bounding_boxes import (
...
class TensorflowObjectDetectionData(ObjectDetectionData):
    def __init__(
        ...
        self._training_annotations_filepaths = None
        self._training_images_filepaths = None
        self._validation_annotations_filepaths = None
        self._validation_images_filepaths = None
        self._testing_annotations_filepaths = None
        self._testing_images_filepaths = None
    ...
    def create(
        ...
        augmentations_object = augmentations_registry.get(
            augmentations, lambda: PassthroughObjectDetectionAugmentations()
        )()
    ...
    def load_annotations(self, y: Tensor) -> Tuple[Tensor, Tensor]:
        return tf.numpy_function(self._annotation_data.get, [y], [tf.float32, tf.int32])
    ...
    @staticmethod
    def map_apply(
        dataset: Dataset, map_fn: Callable[[Tensor, Tensor], Tuple[Tensor, Tensor]]
    ) -> Dataset:
    ...
    def to_annotations_filepaths(
        annotations_directory: Path, images_filepaths: Iterable[Path]
    ) -> List[str]:
