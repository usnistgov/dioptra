...
from mitre.securingai.sdk.object_detection.architectures.tensorflow_layers.backbones import (  # noqa: B950
...
class ARTYOLOV1ObjectDetector(ARTObjectDetector):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(model=model, clip_values=clip_values, preprocessing_defences=preprocessing_defences, **kwargs)
    ...
    def input_shape(self) -> Tuple[int, ...]:
        ...
        """
        return self._model.image_input_shape
