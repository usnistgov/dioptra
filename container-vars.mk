...
CONTAINER_RESTAPI_PY37_CONDA_ENV_FILES =\
    $(CONTAINER_RESTAPI_PY37_INCLUDE_DIR)/environment-restapi.yml
CONTAINER_RESTAPI_PY37_INCLUDE_FILES =\
    $(CONTAINER_RESTAPI_PY37_INCLUDE_DIR)/aws-config\
    $(CONTAINER_RESTAPI_PY37_INCLUDE_DIR)/bash.bashrc\
    $(CONTAINER_RESTAPI_PY37_INCLUDE_DIR)/dot-condarc\
    $(CONTAINER_RESTAPI_PY37_INCLUDE_DIR)/gunicorn.conf.py\
    $(CODE_BUILD_DIR)/$(subst -,_,$(CODE_PKG_NAME))-$(CODE_PKG_VERSION)-py3-none-any.whl\
    $(CODE_DB_MIGRATIONS_FILES)\
    wsgi.py
CONTAINER_RESTAPI_PY37_SCRIPTS =\
    $(CONTAINER_RESTAPI_PY37_INCLUDE_DIR)/entrypoint-restapi.sh\
    $(CONTAINER_RESTAPI_PY37_INCLUDE_DIR)/fix-permissions.sh\
    $(CONTAINER_RESTAPI_PY37_INCLUDE_DIR)/parse-uri.sh\
    $(CONTAINER_RESTAPI_PY37_INCLUDE_DIR)/s3-cp.sh\
    $(CONTAINER_RESTAPI_PY37_INCLUDE_DIR)/s3-mb.sh\
    $(CONTAINER_RESTAPI_PY37_INCLUDE_DIR)/s3-sync.sh\
    $(CONTAINER_RESTAPI_PY37_INCLUDE_DIR)/secure-container.sh\
    $(CONTAINER_RESTAPI_PY37_INCLUDE_DIR)/unpack-archive.sh
