...
def _get_expected_outputs(
    ...
    str_none = registered_types["plugin_param_type6"]["id"]
    dataset = registered_types["plugin_param_type8"]["id"]
    ...
    expected_outputs["sample_test_real_world.py"] = [
        {
            ...
            "missing_types": [
                {"name": "list_str", "description": "List[str]", "proposed_types": []},
                {
                    "name": "tuple_int_int_int",
                    "description": "Tuple[int, int, int]",
                    "proposed_types": [tuple_int_int_int],
                },
                {
                    "name": "optional_float",
            ...
            "missing_types": [
                {
                    ...
                    "proposed_types": [str_none],
                },
                {"name": "int_none", "description": "int | None", "proposed_types": []},
                {
        ...
        },
        {
            ...
            "outputs": [],
            "missing_types": [
                {"name": "list_int", "description": "List[int]", "proposed_types": []},
                {
                    "name": "list_str_path",
                    "description": "List[str | Path]",
                    "proposed_types": [],
        ...
        },
        {
            ...
            "missing_types": [
                ...
                },
                {
                    ...
                    "proposed_types": [list_dict_str_str],
                },
                {
        ...
        },
        {
            ...
            "missing_types": [
                ...
                {"name": "tuple", "description": "Tuple", "proposed_types": []},
            ],
        },
        {
            "name": "augment_patch",
    ...
    expected_outputs["sample_test_function_type.py"] = [
        {
            ...
            "missing_types": [
                {"name": "type1", "description": "foo(2)", "proposed_types": []},
            ],
        }
    ]
    ...
    expected_outputs["sample_test_type_conflict.py"] = [
        {
            ...
            "missing_types": [
                {"name": "type2", "description": "foo(2)", "proposed_types": []},
                {"name": "type1", "description": "Type1", "proposed_types": []},
            ],
        }
    ]
...
def test_signature_analysis(
    ...
    """
    expected = _get_expected_outputs(registered_plugin_parameter_types)
    for fn in expected:
