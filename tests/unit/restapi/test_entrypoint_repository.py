...
# ============================================================================
# region EntrypointRepository.create() tests
# ============================================================================


def test_entrypoint_create_success(db_session: DBSession, account, entrypoint_repo):
...
def test_entrypoint_create_exists(db_session: DBSession, account, entrypoint_repo):
    entrypoint = make_entrypoint(account.user, account.group)
    entrypoint_repo.create(entrypoint)
    db_session.commit()
...
def test_entrypoint_create_name_reuse(db_session: DBSession, account, entrypoint_repo):
    ep1 = make_entrypoint(account.user, account.group)
    entrypoint_repo.create(ep1)
    db_session.commit()
...
# ============================================================================
# region EntrypointRepository.create_snapshot() tests
# ============================================================================
...
# ============================================================================
# region EntrypointRepository.get_by_name() tests
# ============================================================================


def test_entrypoint_get_by_name_exists(
    db_session: DBSession, account, entrypoint_repo, deletion_policy
):
    ...
    snap = entrypoint_repo.get_by_name(ep1.name, ep1.resource.owner, deletion_policy)
...
# ============================================================================
# region EntrypointRepository.get() tests
# ============================================================================


def test_entrypoint_get_single_exists(db_session: DBSession, account, entrypoint_repo):
...
def test_entrypoint_get_single_not_exists(db_session: DBSession, entrypoint_repo):
    result = entrypoint_repo.get(99999, utils.DeletionPolicy.NOT_DELETED)
    assert result is None


def test_entrypoint_get_single_deleted(db_session: DBSession, account, entrypoint_repo):
    ep = make_entrypoint(account.user, account.group, description="description")
    entrypoint_repo.create(ep)
    db_session.commit()
...
def test_entrypoint_get_multiple(db_session: DBSession, account, entrypoint_repo):
    ep1 = make_entrypoint(
...
# ============================================================================
# region EntrypointRepository.get_one() tests
# ============================================================================


def test_entrypoint_get_one_exists(db_session: DBSession, account, entrypoint_repo):
    ep = make_entrypoint(account.user, account.group, description="description")
    entrypoint_repo.create(ep)
    db_session.commit()
...
def test_entrypoint_get_one_not_exists(db_session: DBSession, entrypoint_repo):
    with pytest.raises(errors.EntityDoesNotExistError):
        entrypoint_repo.get_one(99999, utils.DeletionPolicy.NOT_DELETED)


def test_entrypoint_get_one_deleted(db_session: DBSession, account, entrypoint_repo):
    ep = make_entrypoint(account.user, account.group, description="description")
    entrypoint_repo.create(ep)
    db_session.commit()
...
# ============================================================================
# region EntrypointRepository.delete() tests
# ============================================================================


def test_entrypoint_delete_exists(db_session: DBSession, account, entrypoint_repo):
    ep = make_entrypoint(account.user, account.group, description="description")
    entrypoint_repo.create(ep)
    db_session.commit()
...
def test_entrypoint_delete_not_exists(db_session: DBSession, entrypoint_repo):
    with pytest.raises(errors.EntityDoesNotExistError):
...
# ============================================================================
# region EntrypointRepository.get_queues() tests
# ============================================================================


def test_entrypoint_get_queues(entrypoint_with_queues, entrypoint_repo):
...
# ============================================================================
# region EntrypointRepository.create_queues() tests
# ============================================================================


def test_entrypoint_create_queues_success(
    db_session: DBSession, account, entrypoint_repo, fake_data
):
...
# ============================================================================
# region EntrypointRepository.add_queues() tests
# ============================================================================
...
# ============================================================================
# region EntrypointRepository.set_queues() tests
# ============================================================================
...
# ============================================================================
# region EntrypointRepository.unlink_queue() and unlink_queues() tests
# ============================================================================
...
# ============================================================================
# region EntrypointRepository.get_by_filters_paged() tests
# ============================================================================


def test_entrypoint_get_by_filters_paged_empty(db_session: DBSession, entrypoint_repo):
...
def test_entrypoint_get_by_filters_paged_with_invalid_sort(
    db_session: DBSession, entrypoint_repo
):
...
# ============================================================================
# region EntrypointRepository.get_exact() tests
# ============================================================================
...
def test_entrypoint_get_exact_multiple(db_session: DBSession, account, entrypoint_repo):
    ep1 = make_entrypoint(
        account.user, account.group, name="test_ep1", description="description"
    )
    ep2 = make_entrypoint(
...
def test_entrypoint_get_exact_not_exists(db_session: DBSession, entrypoint_repo):
    with pytest.raises(errors.EntityDoesNotExistError):
        entrypoint_repo.get_exact([99999], utils.DeletionPolicy.NOT_DELETED)


def test_entrypoint_get_exact_deleted(db_session: DBSession, account, entrypoint_repo):
    ep = make_entrypoint(account.user, account.group, description="description")
    entrypoint_repo.create(ep)
    db_session.commit()
    ...
    with pytest.raises(errors.EntityDoesNotExistError):
        entrypoint_repo.get_exact([ep.resource_id], utils.DeletionPolicy.NOT_DELETED)


# endregion

# ============================================================================
# region EntrypointRepository.get_one_snapshot() tests
# ============================================================================
