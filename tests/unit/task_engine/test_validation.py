...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"add": {"plugin": "org.example.add", "outputs": "foo"}},
        {"add": {"plugin": "org.example.add", "outputs": ["foo", "bar"]}},
        {"add": {"plugin": "org.example.add"}, "sub": {"plugin": "org.example.sub"}},
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"add": {"plugin": "org.example.add", "outputs": "value", "foo": 123}},
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"step1": {"add": {"a": 1, "b": 2}}},
        {"step1": {"task": "add"}},
        {"step1": {"task": "add", "args": [1, 2]}},
        {"step1": {"task": "add", "kwargs": {"b": 2}}},
        {"step1": {"task": "add", "args": 1, "kwargs": {"b": 2}}},
        {"add1": {"add": [1, 2]}, "add2": {"add": [3, 4]}},
    ],
)
def test_valid_graph(graph):
    experiment_desc = {"tasks": {"add": {"plugin": "org.example.add"}}, "graph": graph}
...
@pytest.mark.parametrize(
    "graph",
    [
        {"step1": {"task1": 1}, "step2": {"task2": "$step1"}},
        {
            "step1": {"task1": 1},
            "step2": {"task2": ["$step1", "$step3.value2"]},
            "step3": {"task3": 123},
        },
        {
            "step1": {"task1": 1},
            "step2": {"task2": "abc"},
            "step3": {"task3": ["$step1", {"arg1": "$step2"}]},
        },
        {
            "step1": {"task1": 1},
            "step2": {
                "task2": {"arg1": "$step1", "arg3": {"subarg1": ["$step3.value2"]}}
            },
            "step3": {"task3": 1},
        },
        {
...
def test_valid_step_references(graph):
    experiment_desc = {
        "tasks": {
            "task1": {"plugin": "org.example.task1", "outputs": "value"},
            "task2": {"plugin": "org.example.task2", "outputs": ["value"]},
            "task3": {"plugin": "org.example.task3", "outputs": ["value1", "value2"]},
        },
        "graph": graph,
    }
...
@pytest.mark.parametrize(
    ...
    [
        {"step1": {"task1": "$param1"}},
        {"step1": {"task1": {"foo": [{"bar": ["$param2"]}]}}},
    ],
)
def test_valid_parameter_references(graph):
    experiment_desc = {
        "parameters": ["param1", "param2"],
        "tasks": {"task1": {"plugin": "org.example.task1", "outputs": "value"}},
        "graph": graph,
    }
...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"step1": {"task1": {"arg1": "$step3"}}, "step3": {"task3": 1}},
        {"step1": {"task1": "$param3"}},
...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"step1": {"task1": 1, "dependencies": ["step1"]}},
        {
            ...
            "step3": {"task3": 3, "dependencies": ["step2"]},
        },
    ],
)
...
@pytest.mark.parametrize(
    "graph",
    [
        {"step1": {"task1": 1, "dependencies": ["step2"]}, "step2": {"task1": 1}},
        {
            "step1": {"task1": 1, "dependencies": ["step2", "step3"]},
            "step2": {"task1": 1, "dependencies": ["step3"]},
            "step3": {"task1": 1},
        },
        {"step1": {"task1": 1, "dependencies": "step2"}, "step2": {"task1": 1}},
    ],
...
@pytest.mark.parametrize(
    "graph",
    [
        {"step1": {"task1": 1, "dependencies": ["step2"]}},
        {
            "step1": {"task1": 1, "dependencies": ["step2", "step3"]},
            "step2": {"task1": 1},
        },
        {"step1": {"task1": 1, "dependencies": 1}},
    ],
)
