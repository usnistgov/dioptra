...
def init_yolo_detectors(
    ...
    object_detector: Model = YOLO_DETECTORS_REGISTRY[model_architecture](
...
YOLO_DETECTORS_REGISTRY: dict[str, Model] = dict(
    yolo_v1=YOLOV1ObjectDetector,
)
