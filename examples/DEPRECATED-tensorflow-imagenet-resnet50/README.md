...
This example demonstrates how to run two simple experiments comparing the FGM evasion attack against multiple defenses on a pre-trained ResNet50 model, as well as a separate experiment making use of the Pixel Threshold attack against the pre-trained ResNet50 model.
...
2.  [Download the ImageNet dataset using the download_data.py script.](../README.md#downloading-datasets)
