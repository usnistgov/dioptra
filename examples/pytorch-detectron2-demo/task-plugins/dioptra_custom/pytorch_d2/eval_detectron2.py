...
@pyplugs.register
def register_dataset(dataset_name, dataset_path, dataset_type, class_names):
    if dataset_type == "detectron2_balloon_json":
        dataset_dict = get_json_dicts(dataset_path, class_names)
    else:
        dataset_dict = get_voc_dicts(dataset_path, class_names)
