...
def train_model(dataset_name,
    ...
    cfg.MODEL.WEIGHTS = model_zoo.get_checkpoint_url(model_architecture)  # Let training initialize from model zoo
    ...
    cfg.MODEL.ROI_HEADS.NUM_CLASSES = len(class_names)  # only has one class (balloon). (see https://detectron2.readthedocs.io/tutorials/datasets.html#update-the-config-for-new-datasets)
