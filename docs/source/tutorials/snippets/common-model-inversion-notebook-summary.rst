...
Running block 5 will generate a new ``shallow_net`` model for classifying :term:`MNIST` images.

Once the models are initialized and the environment is configured, you will be able to run the rest of the demo.
Running block 7 will run the model inversion attack on the :term:`MNIST` shallow_net model.
