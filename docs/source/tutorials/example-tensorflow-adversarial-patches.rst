...
.. warning::
   ...
   Some of the demos assume that you have access to an on-prem deployment of the Securing AI Testbed that provides a copy of the Fruits360 and ImageNet datasets and a CUDA-compatible GPU.
